...
$mail->AddEmbeddedImage('images/avocado1.png', 'avocado1');
$message = 'Hi ' . $firstname . ', welcome to the Avocado Emporium! We\'re so glad to you have as a part of our avocado community. Check out our site to start a subscription! Use this code to get 40% off the "All the Avos" package: NEWMEMBER40';
$mail->Body = $message;
$mail->send();
exit();
